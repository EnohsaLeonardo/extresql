...
import com.bolivia.sqliteextreme.ScannerToData;
import com.bolivia.sqliteextreme.ScannerToData1;
...
public class MainActivityold extends Activity implements OnClickListener{
	...
	public void onResume() {
		super.onResume();
		txtName.setText("Hola " + savedInstanceState.getString("STRING1"));
		...
		switch ( v.getId() )
		{
			...
			case R.id.btnRegistrar:
						            ...
						            ( chIdioma.isChecked() )?"Si":"No" ) )
				{
					...
					bundle.putInt("id", id);
					Intent intent = new Intent( MainActivityold.this, RegistroActivity.class );
			...
			case R.id.btnRegistros:
				Intent iRegs = new Intent( MainActivityold.this, RegistrosActivity.class );
				startActivity( iRegs );
				break;
